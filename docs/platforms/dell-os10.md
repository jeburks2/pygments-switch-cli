...
`discovery-interface ethernet1/1/29-1/1/30` and `interface range`, including
the comma separated lists and the `Po` abbreviation that OS10 expands for
you: `interface range Po 1-19,31-32`.
